...
MyApp.controller('HomeController', function ($scope, $location) {
    ...
    // Hold all of our colors for the tiles
    var COLORS = ['#696969', '#808080', '#A9A9A9']

    // Spawn our tile properties
    ...
    function getView(viewIndex) {

        view_names = ["About", "Games", "Assets"];
        view_urls = ["app/about/about.html", "app/games/games.html", "app/gameAssets/gameAssets.html"];
        view_routes = ["/about", "/games", "/gameAssets"];

        view = new Object();

        view.name = view_names[viewIndex];
        view.url = view_urls[viewIndex];
        view.clickRoute = view_routes[viewIndex];
